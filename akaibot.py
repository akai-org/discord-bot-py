...
class AkaiBot(discord.Client):
    ...
    async def on_raw_reaction_add(self, payload: discord.RawReactionActionEvent):
        ...
        self.logger.debug(
            f"User {payload.member.display_name} reacted with {payload.emoji.name} " f"to message {payload.message_id}"
        )
    ...
    async def on_raw_reaction_remove(self, payload: discord.RawReactionActionEvent):
        ...
        self.logger.debug(
            f"Reaction {payload.emoji.name} from user {member.display_name}"
